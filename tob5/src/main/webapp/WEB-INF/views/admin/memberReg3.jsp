...
<script>
	$(function() {
		AdminMember3.reg(context+'/admin/member_reg3');
	});
...
var AdminMember3 = {
	...
	+'<form role="form"><h2 style="margin-left: 220px;">회원 등록</h2>'
	+'<hr class="colorgraph"><div class="row"><div class="col-xs-12 col-sm-6 col-md-6"><div class="form-group">'
	+'<input type="text" name="userid" id="userid" class="form-control input-lg" placeholder="아이디" tabindex="1" style="width: 450px;">'
	+'</div></div>'
	+'<div class="row"><div class="col-xs-12 col-md-6">'
	+'<a href="#" class="btn btn-success btn-block btn-lg" style="width: 100px; float: right; margin-right: 15px;">중복확인</a>'
	+'</div></div></div>'
	+'<div class="form-group">'
	+'<input type="text" name="password" id="password" class="form-control input-lg" placeholder="비밀번호" tabindex="3"></div>'
	+'<div class="form-group">'
	+'<input type="text" name="name" id="name" class="form-control input-lg" placeholder="이름" tabindex="4"></div>'
	+'<div class="form-group">'
	+'<input type="text" name="birth" id="birth" class="form-control input-lg" placeholder="생일" tabindex="5"></div>'
	+'<div class="form-group">'
	+'<input type="text" name="gender" id="gender" class="form-control input-lg" placeholder="성별" tabindex="6"></div>'
	+'<div class="form-group">'
	+'<input type="text" name="email" id="email" class="form-control input-lg" placeholder="이메일" tabindex="7"></div>'
	+'<div class="form-group">'
	+'<input type="text" name="phone" id="phone" class="form-control input-lg" placeholder="핸드폰" tabindex="8"></div>'
	+'<div class="form-group">'
	+'<input type="text" name="addr" id="addr" class="form-control input-lg" placeholder="주소" tabindex="9"></div>'
	+'<div class="row">'
	...
	+'<strong class="label label-primary">회원가입</strong>을 하기전에 <a href="#" data-toggle="modal" data-target="#t_and_c_m">이용약관</a>을 확인하십시오. '
	+'</div></div>'
	+'<hr class="colorgraph"><div class="row"><div class="col-xs-12 col-md-6">'
	+'<input type="submit" value="회원가입" class="btn btn-primary btn-block btn-lg" tabindex="2" style="margin-left: 180px; width: 200px;">'
	+'</div></div></form></div></div>'
	+'<div class="modal fade" id="t_and_c_m" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'
	+'<div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header">'
	+'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'
	+'<h4 class="modal-title" id="myModalLabel">이용약관</h4></div><div class="modal-body"><p>이용약관 솰라솰라솰라</p></div>'
	+'<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">동의</button>'
	+'</div></div></div></div></div>'
	...
	$("#dup_member_btn").click(function() {
		...
		$.ajax({
			...
			dataType:"json",
			url:"${context}/admin/member_reg3_chk",
			success: function(data) {
				if(data.result == "fail") { 
					alert("이미 가입된 아이디입니다.");
					return false;
