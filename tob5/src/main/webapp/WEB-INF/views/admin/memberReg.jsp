...
/* ============================================================ */
	...
	var AdminMemberReg = {
			...
			init : function(url) {
				$.getJSON(url, function(data) {
					var reg = '<div class="container" >'
					+'<div class="row"><div class="col-md-6 col-md-offset-3">'
					+'<div class="panel panel-login"><div class="panel-heading">'
					+'<div class="row"><div class="col-xs-6">'
					+'<a href="#" class="active" id="login-form-link">관리자등록</a>'
					+'</div><div class="col-xs-6"><a href="#" id="register-form-link">회원 등록</a>'
					+'</div></div><hr></div><div class="panel-body"><div class="row">'
					+'<div class="col-lg-12">'
					+'<form id="login-form" action="http://phpoll.com/login/process" method="post" role="form" style="display: block;">'
					...
					+'<div class="row" style="float: left; margin-top: 20px;"><div class="col-xs-4 col-sm-3 col-md-3">'
					+'<span class="button-checkbox">'
					+'<button type="button" class="btn" data-color="info" tabindex="7">I Agree</button>'
					...
					+'<div class="form-group">'
					+'<input type="password" name="password" id="password" tabindex="2" class="form-control" placeholder="비밀번호"></div>'
					+'<div class="form-group">'
					+'<input type="text" name="name" id="name" tabindex="1" class="form-control" placeholder="이름" value=""></div>'
					+'<div class="form-group">'
					+'<input type="text" name="birth" id="birth" tabindex="1" class="form-control" placeholder="생일" value=""></div>'
					+'<div class="form-group">'
					+'<input type="text" name="gender" id="gender" tabindex="1" class="form-control" placeholder="성별" value=""></div>'
					+'<div class="form-group">'
					+'<input type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="이메일" value=""></div>'
					+'<div class="form-group">'
					+'<input type="text" name="phone" id="phone" tabindex="1" class="form-control" placeholder="Phone(  -없이 입력해주세요)" value=""></div>'
					+'<div class="form-group">'
					+'<input type="text" name="addr" id="addr" tabindex="1" class="form-control" placeholder="주소" value=""></div>'
					...
					+'<div class="modal-header">'
					+'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'
					+'<h4 class="modal-title" id="myModalLabel">사내 규정사항</h4></div>'
					+'<div class="modal-body"><p>사내 규정사항</p></div>'
					+'<div class="modal-footer">'
					+'<button type="button" class="btn btn-primary" data-dismiss="modal">I Agree</button>'
					+'</div></div></div></div>';
 ...
 var AdminMemberStyle = {
	 style : function() {

			$('.panel-login').css('border-color','#ccc').css('-webkit-box-shadow','0px 2px 3px 0px rgba(0,0,0,0.2)').css('','')
			...
			.css('padding','14px 0').css('text-transform','uppercase').css('border-color','#59B2E6');
