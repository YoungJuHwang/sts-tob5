...
<!-- BOOK -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted" id="book_more">더보기</h3>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="purcahse" >
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Purchase</h2>
                    <h3 class="section-subheading text-muted" id="purchase_more">더보기</h3>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted" id="cart_more">더보기</h3>
                </div>
            </div>
        </div>
    </section>
...
$(function() {
	...
	$('#book_more').click(function() {
		location.href ="${context}/book/main";
	});	
	$('#cart_more').click(function() {
		location.href ="${context}/cart/main";
	});	
	$('#purchase_more').click(function() {
		location.href ="${context}/purchase/main";
	});	
