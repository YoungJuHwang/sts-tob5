<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
 ...
 <div class= "로그인" >
  ...
  <div class = "jumbotron" >
     <h1 ><span class ="label label-default" style="background-color:black;">&nbsp;&nbsp;&nbsp;한빛문고&nbsp;&nbsp;&nbsp;</span></h1><br/> 
   ...
   <div class = "form-group">
    ...
    <div class ="container" >
       ...
       <button type= "button" class = "loginConfirm" id="loginConfirm"><h6><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;로그인&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></h6></button>   
       </label>
     </div >
  </form >
</div>
